    ...
    */
    ...
    public class UnitTest3
    {
        ...
        public void TestSampleCode()
        {
            ...
            Assert.AreEqual("Global name: Utility, kind: classKind Class Symbol Table: Utility name: var1, kind: variable, type: int[4][5][7][8][9][1][0] name: var2, kind: variable, type: float name: findMax, kind: function, type: int : int[100] Function Symbol Table: findMax name: array, kind: parameter, type: int[100] name: maxValue, kind: variable, type: int name: idx, kind: variable, type: int name: idx, kind: variable, type: int name: findMin, kind: function, type: int : int[100] Function Symbol Table: findMin name: array, kind: parameter, type: int[100] name: minValue, kind: variable, type: int name: idx, kind: variable, type: int name: idx, kind: variable, type: int name: program, kind: function Function Symbol Table: program name: sample, kind: variable, type: int[100] name: idx, kind: variable, type: int name: maxValue, kind: variable, type: int name: minValue, kind: variable, type: int name: utility, kind: variable, type: Utility name: arrayUtility, kind: variable, type: Utility[2][3][6][7] name: t, kind: variable, type: int name: randomize, kind: function, type: float Function Symbol Table: randomize name: value, kind: variable, type: float", formatSymbolTable(results.SymbolTable));
            Assert.AreEqual("Identifier idx at line 1 has already been declared Identifier idx at line 1 has already been declared Undefined identifier maxValue at line 1 Grammar error: Could not link variable at line 1 Undefined identifier maxValue at line 1 Grammar error: Could not link variable at line 1 Undefined identifier randomize at line 1 Grammar error: Could not link variable at line 1 Identifier sample at line 1 does not have the correct number of indices. Counted 0 expected 1 Identifier sample at line 1 does not have the correct number of indices. Counted 0 expected 1 Cannot perform arithmetic operation at line 1 between factors of type float and float Cannot equate at line 1 a value of type int to float Cannot perform arithmetic operation at line 1 between factors of type float and float Cannot perform arithmetic operation at line 1 between factors of type int and float Cannot perform arithmetic operation at line 1 between factors of type float and int Cannot perform arithmetic operation at line 1 between factors of type int and float Cannot equate at line 1 a value of type int to float", string.Join(" ", results.SemanticErrors));
        }
